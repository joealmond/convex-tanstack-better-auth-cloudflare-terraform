...
import { MessageSquare, Send, LogOut, User, Loader2, Trash2, Shield } from 'lucide-react'
      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-2xl">
        ...
        <div className="mt-8 p-4 rounded-lg bg-muted/50 border border-border">
          ...
          <p className="text-xs text-muted-foreground mt-3 pt-3 border-t border-border">
            Anonymous messages work out of the box. Create an account to share your name across
            features. <strong>Become Admin:</strong> Sign in with a verified email and add it to{' '}
