...
Record original receipt time, case ID, request type, channel and minimal contact details. Acknowledge receipt without claiming resolution. Identify the relevant account or contract from verified records; ask only for proportionate missing information. Do not ask for passwords, full card numbers or CVC. Keep a public channel for requests that cannot depend on login.
...
Record category-specific retention, hold reasons, review date and deletion job. Do not delete open cases or records under a hold. Keep minimal evidence of actions and decisions. Verify cleanup in the app and each provider; document unresolved external copies.
